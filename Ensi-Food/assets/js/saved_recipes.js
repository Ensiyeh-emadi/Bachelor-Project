...
// Retrieves all keys from the localStorage object and filters them to include only those starting with "cookie-recipe". This is  used to identify saved recipes.//ذخیره کارت ها
