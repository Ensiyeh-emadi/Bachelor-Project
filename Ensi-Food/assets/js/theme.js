...
// Initializes a variable isPressed to keep track of the button state.//ایکون و وضعیت دارک و لایت
let isPressed = false;

// Defines a function changeTheme that toggles the theme between light and dark.
// It updates the isPressed state, changes the aria-pressed attribute of the button, updates the theme on the HTML element, and stores the theme preference in the session storage.//کلیک کردن و تعویض تم 
...
//  The click event triggers the changeTheme function when the theme button is clicked.//تم و لود میکنه 
